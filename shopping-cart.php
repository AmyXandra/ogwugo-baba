...
<head>
    <meta charset="utf-8">
    <title>Shopping Cart - SmartMarket</title>
...
<!-- <header class="header header-width-container style4">
    <div class="header-top full-width">
        <div class="container">
            <div class="top-bar-left">
                <div class="header-sale">SHOP EVENTS & SAVE UP TO <span>65% OFF!</span></div>
                <div class="header-contact">Call Us: <span>001-1234-88888</span></div>
            </div>
            <div class="top-bar-right">
                <div class="switcher-current">
                    <a href="#" class="switcher-item">Dollar (US)</a>
                    <ul class="submenu">
                        <li class="menu-item"><a href="#" class="switcher-item">Dollar (US)</a></li>
                        <li class="menu-item"><a href="#" class="switcher-item">Dollar (US)</a></li>
                    </ul>
                </div>
                <div class="switcher-language">
                    <a href="#" class="switcher-item"><img src="images/flag.jpg" alt="img">English</a>
                    <ul class="submenu">
                        <li class="menu-item"><a href="#" class="switcher-item"><img src="images/flag.jpg" alt="img">English</a></li>
                        <li class="menu-item"><a href="#" class="switcher-item"><img src="images/flag.jpg" alt="img">English</a></li>
                    </ul>
                </div>
                <ul class="socials">
    ...
    <div class="container">
        <div class="main-header main-menu-wapper">
            ...
            <div class="box-header-nav">
                <ul class="main-menu clone-main-menu">
                    <li class="menu-item menu-item-has-children"><a href="index.html" class="kt-item-title" title="Home">Home</a>
                        <ul class="submenu">
                    ...
                    <li class="menu-item menu-item-has-children"><a href="shop-categories.html" class="kt-item-title" title="Shop">Shop</a>
                    ...
                    <li class="menu-item menu-item-has-children"><a href="index.html" class="kt-item-title" title="PAGES">PAGES</a>
                        <ul class="submenu">
                    ...
                    <li class="menu-item menu-item-has-children"><a href="index.html" class="kt-item-title" title="Blog">Blog</a>
                        <ul class="submenu">
                    ...
                    <li class="menu-item"><a href="index.html">PURCHASE THEME</a></li>
                </ul>
            </div>
        ...
        <div class="header-nav margin-bottom-15">
    ...
    <div class="site-content-inner">
        ...
        <div class="container">
            <div class="step-by-step">
                <ul class="list-step">
                    <li class="items-step active"><span><p>Shopping Cart</p></span></li>
                    <li class="items-step"><span><p>CheckOut</p></span></li>
                    <li class="items-step"><span><p>Order Completed</p></span></li>
                </ul>
            </div>
        </div>
        <div class="container">
            <div class="product-cart shipping-process margin-bottom-45">
                <!-- <table class="shop-table cart">
                    ...
                    <tr>
                        ...
                        <th class="product-remove"><span class="remove none"><i class="fa fa-times"></i></span></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr class="cart-item">
                        <td class="product-thumbnail" data-title="Image">
                            <a href="#"><img src="images/items1.jpg" alt="img"/></a>
                        </td>
                    ...
                    <tr class="cart-item">
                        <td class="product-thumbnail" data-title="Image">
                            <a href="#"><img src="images/items2.jpg" alt="img"/></a>
                        </td>
                        <td class="product-name" data-title="Product Name">
                    ...
                    <tr class="cart-item">
                        <td class="product-thumbnail" data-title="Image">
                            <a href="#"><img src="images/items3.jpg" alt="img"/></a>
                        </td>
                        <td class="product-name" data-title="Product Name">
                            <a href="#">Blue Yeti USB Microphone</a>
                        </td>
                        <td class="product-price" data-title="Price">
                            <span class="price">$460.00</span>
                        </td>
                ...
                <a href="#" class="btn-check update">UPDATE CART</a>
                <table class="table table-bordered table-borderless">
                    <thead>
                        <tr>
                        <th>Product Name</th>
                        <th>Quantity</th>
                        <th>Your Offer (per unit price)</th>
                        <th></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <td style="width: 35%;">
                            <div>
                                <div class="col-md-2">
                                        <img src="images/shoe-logo.jpg" style="width:50px;height:50%;">
                                </div>
                                <div class="col-md-10">
                                    <p>Vintage Bronze Potter Necklace Hogwarts School Badge Pocket Quartz Harry Pocket Watch</p>
                                </div>
                            </div>
                        </td>
                        <td><input type="text"> Piece(s)</td>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4">
                        <div class="form-shipping">
                            <h3 class="title">Estimate Shipping And Tax</h3>
                            <p class="des">Enter your destination to get shipping & tax</p>
                            <div class="box-select first-child">
                                <span class="shipping-label">COUNTRY *:</span>
                                <select name="position">
                                    <option value="position1">Select options</option>
                                    <option value="position1">USA</option>
                                    <option value="position2">Korea</option>
                                </select>
                            </div>
                            <div class="box-select">
                                <span class="shipping-label">STATE / PROVINCE *:</span>
                                <select name="position">
                                    <option value="position1">Select options</option>
                                    <option value="position1">USA</option>
                                    <option value="position2">Korea</option>
                            ...
                            <div class="box-select last-child">
                                <span class="shipping-label">ZIP / POSTAL CODE *:</span>
                                <select name="position">
                                    <option value="position1">Select options</option>
                                    <option value="position1">USA</option>
                                    <option value="position2">Korea</option>
                            ...
                            <a href="#" class="btn-check process">GET A QUOCTE</a>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4">
                        <div class="form-shipping">
                            <h3 class="title">DIscount Codes</h3>
                            <p class="des">Enter your coupin if you have one</p>
                            <div class="form-input">
                                <input type="text" class="input-form" id="name">
                            </div>
                            <a href="#" class="btn-check process">SUBSCRIBE</a>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4">
                        <div class="form-shipping order">
                            <h3 class="title">Cart Total</h3>
                            <div class="shipping-left">SUB TOTAL:<span class="price">$460.00</span></div>
                            <div class="shipping-left">GRAND TOTAL:<span class="price">$460.00</span></div>
                            <p class="des">Checkout with multiple address</p>
                            <a href="checkout.html" class="btn-check process">PROCESS TO CHECKOUT</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="brand-slide">
                <div class="owl-carousel nav-style-1" data-nav="false" data-autoplay="false" data-dots="false" data-loop="true" data-margin="0" data-responsive='{"0":{"items":2},"480":{"items":3},"640":{"items":4},"991":{"items":6}}'>
                    <a href="#"><img src="images/brand1.jpg" alt="brand"></a>
                    <a href="#"><img src="images/brand2.jpg" alt="brand"></a>
                    <a href="#"><img src="images/brand3.jpg" alt="brand"></a>
                    <a href="#"><img src="images/brand4.jpg" alt="brand"></a>
                    <a href="#"><img src="images/brand5.jpg" alt="brand"></a>
                    <a href="#"><img src="images/brand6.jpg" alt="brand"></a>
                </div>
            </div>
        </div>
    </div>
...
<footer class="footer footer-style-1">
    <div class="container">
        <div class="footer-top auto-clear">
            <div class="row">
                <div class="col-ts-12 col-xs-6 col-sm-6 col-md-5">
                    ...
                    <div class="footer-infomation">
                        <p>101 E 129th St, East Chicago,<br>
                            IN 46312, US</p>
                        <p>Phone: 001-1234-88888</p>
                        <p>Email: Kutethemes@gmail.com</p>
                    </div>
                    <div class="social-footer">
                        <span class="social-text">GET IN TOUCH !</span>
                        <ul class="socials">
                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-ts-12 col-xs-6 col-sm-6 col-md-3">
                    <div class="menu-footer">
                        <h3 class="title-footer">Find It Fast</h3>
                        <ul class="menu">
                            <li class="menu-item"><a href="#">Laptop $ Computers</a></li>
                            <li class="menu-item"><a href="#">Smart Phone & Tablets</a></li>
                            ...
                            <li class="menu-item"><a href="#">Car Electronic & GP5</a></li>
                            <li class="menu-item"><a href="#">Accesories</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-ts-12 col-xs-6 col-sm-6 col-md-2">
                    <div class="menu-footer">
                        ...
                        <ul class="socials">
                            <li class="menu-item"><a href="#">Find a Store</a></li>
                ...
                <div class="col-ts-12 col-xs-6 col-sm-6 col-md-2">
                    <div class="menu-footer">
                        <h3 class="title-footer">Customer Care</h3>
                        <ul class="socials">
            ...
            <div class="container">
                <div class="newsletter-form-wrap">
                    <div class="newsletter-form">
                        <div class="title-label-newsletter">
                            <span class="label-b">Sign Up to <span>News letter</span></span>
                            <span class="label-s">Subscribe our newsletter gor get notification about information discount.</span>
                        </div>
        ...
        <div class="footer-copyright">
            <p class="copyright">Copyright 2018 <a href="index.html  ">©SmartMarket</a> design by Kutethemes</p>
            <div class="pay-men"><a href="#"><img src="images/paymen.png" alt="paymen"></a></div>
        </div>
    </div>
    <!-- Back To Top -->
